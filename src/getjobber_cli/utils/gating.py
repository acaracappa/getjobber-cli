...
message until the write redesign lands (v1.3.0).
...
_MESSAGE = (
    ...
    "for v1.3.0). Read commands — list, get, search — are fully supported."
)


def write_command_pending(func):
    """Short-circuit a write command until the v1.3.0 write redesign.
